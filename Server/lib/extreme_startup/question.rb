...
module ExtremeStartup
  class Question
    ...
    def log_result
        "|question: #{self.to_s}|answer: #{answer}|expected: #{correct_answer}|result: #{result}"
    end
  ...
  class GeneralKnowledgeQuestion < Question
    class << self
      def question_bank
        [
          ["where do you work", "Houston Inc."],
          ["who is your BOSS", "Tomi Ruotimo"],
          ["which city is the Naesinneula in", "Tampere"],
          ["onko hauki kala", "on"],
